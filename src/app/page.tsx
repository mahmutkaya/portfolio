  ...
  return (
    <div className="min-h-screen">
      ...
      <section className="py-20 px-4 animate-fade-in relative">
        <div className="absolute inset-0 bg-dark-100 opacity-30 z-0">
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12">
            <div className="md:w-1/2 animate-slide-up">
              ...
              <div className="flex mt-8 gap-4">
                <a href="https://github.com/mahmutkaya" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary transition-colors">
                ...
                <a href="https://linkedin.com/in/mahmut-kaya" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-primary transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                  </svg>
                </a>
                <a href="mailto:contact@mahmutkaya.com" className="text-gray-400 hover:text-primary transition-colors">
                  <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="currentColor">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8">
            {skills.map((skill, index) => (
              ...
              >
                ...
                <h3 className="text-lg font-medium text-center mt-2">{skill.name}</h3>
                <div className="w-full bg-dark-300 h-2 rounded-full mt-2 overflow-hidden">
                  <div 
            ...
            {experiences.map((exp, index) => (
              ...
              >
                <div className="flex flex-col md:flex-row md:items-center justify-between mb-4">
                  ...
                  <div className="text-gray-400 bg-dark-300 px-3 py-1 rounded-full text-sm mt-2 md:mt-0">{exp.period}</div>
                </div>
      ...
      {/* Call to Action */}
      <section className="py-20 px-4 bg-gradient-to-b from-dark-200 to-dark-100 relative">
