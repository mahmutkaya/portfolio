      ...
      <div className="container mx-auto max-w-4xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
          <div>
            ...
            <div className="space-y-6">
              <div>
                ...
                <p className="text-gray-300">Leiden, 2315 AC, Netherlands</p>
              </div>
              
              <div>
                <h3 className="text-lg font-semibold mb-2">Email</h3>
                <a 
                  href="mailto:mahmutkaya.nl@gmail.com" 
          ...
          <div>
            ...
            {submitSuccess ? (
              <div className="bg-green-900/50 border border-green-500 text-green-100 p-4 rounded-lg">
