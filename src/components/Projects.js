      ...
      <React.Fragment>
        ...
        <Row className="mb-4">
          <Col sm="12">
            <Card>
              <CardBody>
                <CardTitle tag="h3">Playwright-Cucumber-TypeScript Framework</CardTitle>
                <CardText>
                  A comprehensive test automation framework built for UI, API, and database testing. This framework implements the BDD approach using Cucumber and TypeScript with Playwright for browser automation.
                </CardText>
                <CardText>
                ...
                <Button color="primary" href="https://github.com/mahmutkaya/pw-cucumber-ts-api-ui" target="_blank">View on GitHub</Button>
              </CardBody>
            </Card>
          </Col>
        </Row>
        ...
        <Row className="mb-4">
          <Col sm="12">
            <Card>
              <CardBody>
                <CardTitle tag="h3">WinAppDriver Desktop Testing Framework</CardTitle>
                <CardText>
                  A test automation framework for Windows desktop applications using WinAppDriver with Java and TestNG.
                </CardText>
                <CardText>
                  <strong>Features:</strong>
                  <ul>
                    ...
                    <li>Element identification strategies for desktop applications</li>
                    <li>Custom reporting</li>
                  </ul>
                </CardText>
                <Button color="primary" href="https://github.com/mahmutkaya/windowsAppTest" target="_blank">View on GitHub</Button>
              </CardBody>
            </Card>
          </Col>
        </Row>
